        ...
        <section id="metaverse" className="section-metaverse">
            ...
            <div className="deck-ship">
                <div className="deck-bg">
                    <img className="" src="images/home/deck-ship.png" alt="" srcSet="" />
                </div>
                <div className="robo-run">
                    <img src="images/home/robo-run.png" alt="" srcSet="" />
                </div>
            </div>    
            ...
            <div className="meta-bg">
                <div className="content-bg">
                    ...
                    <div className="logo-3d-right">
                        <img src="images/home/logo-3d-right.svg" alt=""/>
                    </div>
                    ...
                    <div className="metaverse-robo">
                        <img src="images/home/metaverse-robo.png" alt="" srcSet="" />
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-8 metaverse-content">
                        ...
                        <div className="metaverse-description d-flex flex-row">
                            ...
                            <div className="desc col">
                                <p>
                                    TEAM™ will be an all-encompassing guild, diversified across numerous games
                                    and resilient in
                                    tokenomic.
                                </p>
                            </div>
