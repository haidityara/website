        ...
        <section id="treasury">
            <div className="treasury-bg">
                <div className="content-bg position-relative">
                    ...
                    <div className="galaxy-night">
                        <img src="images/treasury/galaxy-night-landscape.png" alt="Galaxy night"/>
                    </div>
                    <div className="image-3d-4">
                        <img className="_float" src="images/treasury/logo-3d-4.png" alt=""/>
                    </div>
                    <div className="image-3d-3">
                        <img className="_float" src="images/treasury/logo-3d-3.png" alt=""/>
                    </div>
                    <div className="meteoroid">
                        <img src="images/home/meteoroid.svg" alt="" srcSet="" />
                    </div>
                </div>
            </div>
            <div className="container main-content position-relative">
                ...
                <div className="wrap-grid-2 w-100 position-relative d-flex justify-content-center">
                    ...
                    <img src="images/treasury/Group-245.svg" className="parabola-img" alt=""/>
